...
import type { AsmrTimelapseGenerator, VisualStyleKey } from "../types";

export default function VisualStyleSection({ gen }: { gen: AsmrTimelapseGenerator }) {
