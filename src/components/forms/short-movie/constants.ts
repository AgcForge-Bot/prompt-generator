...
export const MOVIE_REFS: Record<GenreCategoryKey, { title: string; story: string }[]> = {
	...
	adventure: [
		...
		{ title: 'Jungle (2017)', story: 'A group of friends join a guide for a trek into the Bolivian jungle, searching for an Indian village. The men soon realize that the jungle is a difficult place to be.' },
		{ title: "Apocalypto (2006)", story: "As the Mayan kingdom faces its decline, a young man is taken on a perilous journey to a world ruled by fear and oppression." },
		{ title: "Backcountry (2014)", story: "An urban couple goes camping in the woods and find themselves lost in the territory of a predatory black bear." },
		{ title: "Rescue Dawn (2006)", story: "A U.S. fighter pilot's epic struggle of survival after being shot down on a mission over Laos during the Vietnam War." },
		{ title: "Into the Wild (2007)", story: "After graduating from Emory University, top student and athlete Christopher McCandless abandons his possessions, gives his entire $24,000 savings account to charity and hitchhikes to Alaska to live in the wilderness." },
		{ title: "The Grey (2011)", story: "After their plane crashes in Alaska, six oil workers are led by a skilled huntsman to survival, but a pack of merciless wolves haunts their every step." },
		{ title: "The Mountain Between Us (2017)", story: "Stranded after a tragic plane crash, two strangers must forge a connection to survive the extreme elements of a remote snow-covered mountain. When they realize help is not coming, they embark on a perilous journey across the wilderness." },
		{ title: "Arctic (2018)", story: "A man stranded in the Arctic after a plane crash must decide whether to remain in the relative safety of his makeshift camp or to embark on a deadly trek through the unknown." },
		{ title: "6 Below: Miracle on the Mountain (2017)", story: "An adrenaline seeking snowboarder gets lost in a massive winter storm in the back country of the High Sierras where he is pushed to the limits of human endurance and forced to battle his own personal demons as he fights for survival" },
		{ title: "Society of the Snow (2023)", story: "The flight of a rugby team crashes on a glacier in the Andes. The few passengers who survive the crash find themselves in one of the world's toughest environments to survive." },
		{ title: "Cast Away (2000)", story: "A FedEx executive undergoes a physical and emotional transformation after crash landing on a deserted island." },
		{ title: "127 Hours (2010)", story: "A mountain climber becomes trapped under a boulder while canyoneering alone near Moab, Utah and resorts to desperate measures in order to survive." },
		{ title: "Alive (1993)", story: "After crash-landing in the snowswept Andes, a Uruguayan rugby team has no choice but to turn to desperate measures in order to survive." },
		{ title: "The Road (2009)", story: "In a dangerous post-apocalyptic world, an ailing father defends his son as they slowly travel to the sea." },
		{ title: "Touching the Void (2003)", story: "The true story of two climbers and their perilous journey up the west face of Siula Grande in the Peruvian Andes in 1985." },
		{ title: "Lone Survivor (2013)", story: "Marcus Luttrell and his team set out on a mission to capture or kill notorious Taliban leader Ahmad Shah, in late June 2005. Marcus and his team are left to fight for their lives in one of the most valiant efforts of modern warfare." },
		{ title: "Life of Pi (2012)", story: "A young man who survives a disaster at sea is hurtled into an epic journey of adventure and discovery. While cast away, he forms an unexpected connection with another survivor: a fearsome Bengal tiger." },
	],
